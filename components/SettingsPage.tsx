...
export function SettingsPage() {
  ...
  return <div>
    ...
    <div className="settings-grid">
      ...
      <section className="panel"><span className="eyebrow">LOCAL → CLOUD</span><h2>Import browser cache</h2><p>If you used the old local-only prototype before signing in, this can upload that browser's cached notes, cards, assignments, resources and mistakes.</p><button className="button secondary" onClick={importLocal}>Import local cache</button></section>
